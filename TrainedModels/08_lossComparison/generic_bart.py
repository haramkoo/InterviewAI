...
tokenizer = BartTokenizer.from_pretrained("../06_bartGenericNames/model/bart-generic-names")
model = BartForConditionalGeneration.from_pretrained("../06_bartGenericNames/model/bart-generic-names")
