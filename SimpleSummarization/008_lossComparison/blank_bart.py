...
tokenizer = BartTokenizer.from_pretrained("../004_bartBlankPrompt/bart-blank")
model = BartForConditionalGeneration.from_pretrained("../004_bartBlankPrompt/bart-blank")
