...
tokenizer = BartTokenizer.from_pretrained("../006_bartGenericNames/bart-generic-names")
model = BartForConditionalGeneration.from_pretrained("../006_bartGenericNames/bart-generic-names")
