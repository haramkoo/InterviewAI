...
tokenizer = BartTokenizer.from_pretrained("../06_bartGenericNames/bart-generic-names")
model = BartForConditionalGeneration.from_pretrained("../06_bartGenericNames/bart-generic-names")
